	...
	<div class='container' style='min-height: 480px'>
		<div class='sub-content' id='login-atau-tambah-admin'>
			<div class='sub-container'>
				<marquee class='welcome' scrollamount='6'><h3>Selamat Datang di Aplikasi Pengelolaan Laporan Pertanggungjawaban Dinas Komunikasi dan Informatika Kabupaten Lebak</h3></marquee>
			</div>
			<div class='sub-container'>
				...
				<div class='cust-login register'>
					...
					<p>Aplikasi Laporan Pertanggungjawaban Keuangan adalah aplikasi berbasis web untuk membantu Bendahara dalam menyusun dan mengelola laporan keuangan. Aplikasi ini bermanfaat untuk memudahkan Bendahara dalam penyusunan format Laporan Pertanggungjawaban Keuangan.</p>
				</div>
			</div>
		</div>
	</div>
