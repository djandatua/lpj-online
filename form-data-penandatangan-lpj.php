		...
		?>
			<form id='penandatangan-lpj' name='penandatangan-lpj' action='simpan-data-penandatangan-lpj.php' method='POST'>
				...
				<table style='margin-top: 20px;'>
					<tbody>
						<tr>
							<td style='width: 200px;'><label for='NIP-2'>Nama Penerima</label></td>
							<td>: <input id='NIP-2' name='NIP-2' type='text' value='<?php echo $data_ptd['PENERIMA'] ?>' style='width:500px;' /></td>
						</tr>
