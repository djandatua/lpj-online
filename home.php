...
<div class='sub-content' id='home-panel'>
	...
	<div class='sub-container noflex'>
		<marquee class='welcome' scrollamount='6'><h3><?php echo get_nama_admin($_SESSION['login_session']['user_id']) ?>, Selamat Datang di Aplikasi Pengelolaan Laporan Pertanggungjawaban Dinas Komunikasi Dan Informatika Kabupaten Lebak</h3></marquee>
	</div>
