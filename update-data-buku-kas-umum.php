...
if (isset($_POST['submit-update-bku'])) {
	...
	$query = "UPDATE TB_BUKU_KAS_UMUM SET BKU_NO_URUT='$no_urut', BKU_TGL_SUB_KEG='$tgl', BKU_KODE_REK='$kodering', BKU_URAIAN='$uraian', BKU_URAIAN_RO='$uraian_ro', BKU_ATAS_NAMA='$atas_nama', BKU_PENERIMAAN='$penerimaan', BKU_PENGELUARAN='$pengeluaran', BKU_PAJAK='$pajak'
