				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>: <input id='BKU-URAIAN-RO' name='BKU-URAIAN-RO' type='text' value='<?php echo $bku['BKU_URAIAN_RO'] ?>' style='width:400px' /></td>
						</tr>
						<tr>
							<td style='width: 200px;'><label for='BKU-ATASNAMA'>Atas Nama</label></td>
							<td>: <input id='BKU-ATASNAMA' name='BKU-ATASNAMA' type='text' value='<?php echo $bku['BKU_ATAS_NAMA'] ?>' style='width:400px;' /></td>
						</tr>
						<tr>
